...
target 'ThinkSNSPlus' do
  ...
  pod 'TYAttributedLabel', :git => 'https://github.com/zhiyicx/TYAttributedLabel.git'# 富文本Label（其实是个View）
  pod 'Hyphenate', '3.3.6'		            # 环信
  pod 'Masonry', '1.1.0'                 # 视图布局
  pod 'JPush', '3.0.3'                      # 极光推送
  pod 'Bugly', '2.4.8'                      # 崩溃收集
  pod 'GCDWebServer/WebUploader', '3.4.2'   # web上传功能
  pod 'Vivid'             # 图片处理
  pod 'SCRecorder', :git => 'https://github.com/LipYoung/SCRecorder.git' # 视频录制
  pod 'ZFPlayer', :git => 'https://github.com/slimkit/ZFPlayer.git' #播放器
  pod 'TZImagePickerController', :git => 'https://github.com/slimkit/TZImagePickerController.git' # 视频.图片选择框架
  pod 'MarkdownView', :git => 'https://github.com/slimkit/MarkdownView.git'# markdown 渲染器基于 webview
  pod 'Alamofire', '4.7.3'
  pod 'ObjectMapper', '3.3.0'
  ### fork 的 activelabel 库，用于付费文字和超链接文字的显示
  pod 'ActiveLabel', :git => 'https://github.com/slimkit/ActiveLabel.swift.git'
  ### '即时聊天相关
  pod 'Starscream', '2.0.2'                 # websocket 协议实现
  pod 'JSQMessagesViewController', :git => 'https://github.com/slimkit/JSQMessagesViewController.git', :branch => '7.3.4'  # 消息UI
