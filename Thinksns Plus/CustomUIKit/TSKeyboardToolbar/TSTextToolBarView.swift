...
protocol TSTextToolBarViewDelegate: NSObjectProtocol {
    func sendTextMessage(message: String, inputBox: AnyObject?)
}

class TSTextToolBarView: UIView, UITextViewDelegate {

    typealias ChangeHeightClosure = (CGFloat) -> Void

    let scrollMaxHeight: CGFloat = 120
    // 按钮圆角
    ...
    // 下分割线左边距
    private let bottomLineLeftmargin: CGFloat = 10.0
    // 下分割线右边距
