...
class TSErrorTipActionsheetView: UIView, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate {
    ...
    func setHeaderView(headerTitle: String, headerContent: String) -> UIView {
        ...
        titlelabel.font = UIFont.systemFont(ofSize: TSFont.Button.navigation.rawValue)
    ...
    func showTableView() {
        UIView.animate(withDuration: 0.2, animations: {
            ...
            self.actionSheetTableView?.frame.origin.y = UIScreen.main.bounds.height - (self.actionSheetTableView?.bounds.size.height)!
        })
    }
    /// 点击背景视图
    func tapBg() {
