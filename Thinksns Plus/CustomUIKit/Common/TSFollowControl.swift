...
class TSFollowControl: UIControl {
    ...
    override var isSelected: Bool {
        didSet {
            ...
            self.titleLabel.textColor = isSelected ? UIColor(hex: 0xcccccc) : UIColor(hex: 0x59b6d7)
            self.layer.borderColor = isSelected ? UIColor(hex: 0xcccccc).cgColor : UIColor(hex: 0x59b6d7).cgColor
        }
    }
    ...
    private func initialUI() -> Void {
        ...
        self.layer.borderColor = UIColor(hex: 0x59b6d7).cgColor
        // 1. titleLabel
        let titleLabel = UILabel(text: "", font: UIFont.systemFont(ofSize: 13), textColor: UIColor(hex: 0x59b6d7))
