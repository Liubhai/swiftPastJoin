    ...
    switch (self.model.bodyType) {
        ...
        case EMMessageBodyTypeImage:
        {
            if (self.model.message.ext.count > 0 && [self.model.message.ext[@"image"] boolValue] == YES) {
                ...
                self.bubbleView.bottomBgView.frame = CGRectMake(0, self.bubbleView.imageView.frame.size.height - 40, self.bubbleView.imageView.frame.size.width, 40);
                self.bubbleView.bottomBgView.hidden = NO;
                self.bubbleView.bottomTitleLabel.frame = CGRectMake(7, 0, self.bubbleView.bottomBgView.frame.size.width - 7* 2, 20);
                self.bubbleView.bottomTitleLabel.center = CGPointMake(self.bubbleView.bottomBgView.frame.size.width / 2.0, self.bubbleView.bottomBgView.frame.size.height / 2.0);
