...
class TSMeViewController: TSViewController, didMeSelectCellDelegate, SendSuccessImageDelegate, TSFansAndFollowVCProtocol, TSCustomAcionSheetDelegate {
    ...
    let tableViewTitleSource = [["个人主页", "用户认证", "我的\(TSAppConfig.share.localInfo.goldName)"], ["我的文章", "我的圈子", "我的收藏", "我的问答"], ["草稿箱", "设置"]]

    /// 页面展示的图片数据
    let tableViewImgSource = [[#imageLiteral(resourceName: "IMG_ico_me_homepage"), #imageLiteral(resourceName: "IMG_ico_me_identification"), #imageLiteral(resourceName: "IMG_ico_me_integral.png")], [ #imageLiteral(resourceName: "IMG_ico_me_contribute"), #imageLiteral(resourceName: "IMG_ico_me_circle"), #imageLiteral(resourceName: "IMG_ico_me_collect"), #imageLiteral(resourceName: "IMG_ico_me_q&a")], [#imageLiteral(resourceName: "IMG_ico_me_draft"), #imageLiteral(resourceName: "IMG_ico_me_setting")]]
...
//            navigationController?.pushViewController(wallet, animated: true)
    ...
    func sendImageWithTemplate(image: UIImage) {
        self.meView.showMeHeader.avatar.buttonForAvatar.setImage(image, for: .normal)
    }
