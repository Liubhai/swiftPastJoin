...
class TSPhonographView: UIView, CAAnimationDelegate {
    ...
    func creatViews(frame: CGRect) {
        ...
        self.songCoverView.layer.masksToBounds = false
        ...
        self.RotationPhonograph.center = CGPoint(x: self.songCoverView.frame.width * 0.5, y: self.songCoverView.frame.height * 0.5)
        self.RotationPhonograph.image = UIImage(named: "IMG_music_pic_phonograph_ring_01")
        self.songCoverView.addSubview(self.RotationPhonograph)
    }
