...
class TSMusicCommentToolView: UIView, TSTextToolBarViewDelegate {

    var commentToolView: TSTextToolBarView? = nil
    ...
    func creatTextCommentView() {
        ...
        self.commentToolView = TSTextToolBarView(frame: CGRect(x: 0, y: 0, width: frame.width, height: frame.height), superViewSourceHeight: TSMusicCommentToolViewUX.commentToolViewHeight)
