...
extension TSContacts {
    ...
    func getContactsInfo() -> [TSContactModel] {
        do {
            ...
            let keysToFetch = [CNContactFamilyNameKey, CNContactGivenNameKey, CNContactMiddleNameKey, CNContactPhoneNumbersKey, CNContactImageDataKey, CNContactImageDataAvailableKey]
