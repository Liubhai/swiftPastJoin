...
class TSDiscoverViewController: TSViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    #if DEBUG
    let cellTitleConfig = [["资讯", "圈子", "问答"], [ "排行榜", "话题"], ["找人"], ["测试"]]
    let cellImageConfig = [["IMG_discover_ico_information", "IMG_discover_ico_channel", "IMG_discover_ico_queansw"], ["IMG_discover_ico_rankinglist", "discover_ico_topic", "IMG_discover_ico_buy", "discover_ico_topic"], ["IMG_discover_ico_findpeople"], ["IMG_ico_circle_limits"]]
    #else
    let cellTitleConfig = [["资讯", "圈子", "问答"], [ "排行榜", "话题"], ["找人"]]
    let cellImageConfig = [["IMG_discover_ico_information", "IMG_discover_ico_channel", "IMG_discover_ico_queansw"], ["IMG_discover_ico_rankinglist", "discover_ico_topic", "IMG_discover_ico_buy", "discover_ico_topic"], ["IMG_discover_ico_findpeople"]]
    #endif
