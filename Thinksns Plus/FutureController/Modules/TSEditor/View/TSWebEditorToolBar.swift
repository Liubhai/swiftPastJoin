...
class TSWebEditorToolBar: UIView {
    ...
    fileprivate func initialDataSource() -> Void {
        var itemNames = ["IMG_ico_tools_packup", "IMG_ico_tools_link", "IMG_ico_tools_line", "IMG_ico_tools_font", "IMG_ico_tools_laststep", "IMG_ico_tools_nextstep", "IMG_ico_tools_picture"]
        var textStyles: Array<TSEditorTextStyle> = [TSEditorTextStyle.none, TSEditorTextStyle.link, TSEditorTextStyle.hr, TSEditorTextStyle.none, TSEditorTextStyle.undo, TSEditorTextStyle.redo, TSEditorTextStyle.image]
        // 显示设置按钮选项
