...
extension TSNewsCommentController: TSNewsDetailToolbarDelegate {
    ...
    func didClickDeleteNewsOptionIn(toolbar: TSNewsDetailToolbarView) {
        self.showNewsDeleteConfirmAlert()
    }
}

extension TSNewsCommentController {
    /// 显示资讯删除的二次确认弹窗
    func showNewsDeleteConfirmAlert() -> Void {
    ...
    /// 删除资讯
    fileprivate func deleteNews() -> Void {
