    ...
    internal func loadContentLabel(topRecord: inout CGFloat) {
        ...
        if !shouldAddFuzzyString {
            ...
            if arr.count > 6 {
                ...
                let mutable: NSMutableAttributedString = NSMutableAttributedString.init(attributedString: (contentLabel.attributedText?.attributedSubstring(from: lastRange!))!)
...
//                    }
    ...
    func loadFromLabel(topRecord: inout CGFloat) {
        ...
        let fromString = NSMutableAttributedString.attributeStringWith(strings: ["来自 ", model.from], colors: [UIColor(hex: 0xb2b2b2), UIColor(hex: 0x59b6d7)], fonts: [12, 12])
